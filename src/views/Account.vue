<template>
  <div class="account">
    ...
    <van-cell-group>
      ...
      <van-cell class="v-cell" title="用户id" :value="userInfo.userId"></van-cell>
      <van-cell class="v-cell" title="手机号" :value="userInfo.phone"></van-cell>
      <van-cell class="v-cell" title="昵称">
        <div class="clearfix">
          <div class="fr">
            <van-field @blur="updateUserInfo({key: 'nickName', value: userInfo.nickName, url: '/updateNickName'})" class="v-filed" v-model="userInfo.nickName" input-align="right" />
          </div>
        </div>
      </van-cell>
      <van-cell>
        <div class="clearfix">
          ...
          <div class="fl v-cell-textarea">
            <textarea @change="updateUserInfo({key: 'desc', value: userInfo.desc, url: '/updateDesc'})" class="textarea" v-model="userInfo.desc"></textarea>
          </div>
        </div>
      </van-cell>
    </van-cell-group>
